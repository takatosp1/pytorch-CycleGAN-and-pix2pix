...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--data_seglabel', type=int, default=0, help='if the dataset has seg label or not')
        ...
        parser.add_argument('--crop_replace',default='image', type=str, help='What to replace the cropped blocks [image|black|white|gray|rand]')
        ...
        parser.add_argument('--add_D_feat_loss', type=int, default=0, help='wether add feature matching loss')
